...
#define WHITE_BRICK {1,FIRST_LINE,BRICK_WIDTH,BRICK_HEIGHT}
#define ORANGE_BRICK {32,FIRST_LINE,BRICK_WIDTH,BRICK_HEIGHT}
#define BLUE1_BRICK {63,FIRST_LINE,BRICK_WIDTH,BRICK_HEIGHT}
#define GREEN1_BRICK {94,FIRST_LINE,BRICK_WIDTH,BRICK_HEIGHT}
#define BLUE2_BRICK {125,FIRST_LINE,BRICK_WIDTH,BRICK_HEIGHT}
#define GREEN2_BRICK {156,FIRST_LINE,BRICK_WIDTH,BRICK_HEIGHT}
#define RED_BRICK {1,(FIRST_LINE * 16),BRICK_WIDTH,BRICK_HEIGHT}
#define BLUE3_BRICK {32,(FIRST_LINE * 16),BRICK_WIDTH,BRICK_HEIGHT}
#define PINK_BRICK {94,(FIRST_LINE * 16),BRICK_WIDTH,BRICK_HEIGHT}
#define YELLOW_BRICK {125,(FIRST_LINE * 16),BRICK_WIDTH,BRICK_HEIGHT}
#define RED2_BRICK {156,(FIRST_LINE * 16),BRICK_WIDTH,BRICK_HEIGHT}
#define BLUE4_BRICK {63,(FIRST_LINE * 16),BRICK_WIDTH,BRICK_HEIGHT}
#define GREY_BRICK {1,(FIRST_LINE * 32),BRICK_WIDTH,BRICK_HEIGHT}
