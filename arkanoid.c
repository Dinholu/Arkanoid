...
#define WHITE_BRICK {1,1,BRICK_WIDTH,BRICK_HEIGHT}
#define ORANGE_BRICK {31,1,BRICK_WIDTH,BRICK_HEIGHT}
#define BLUE1_BRICK {63,1,BRICK_WIDTH,BRICK_HEIGHT}
#define GREEN1_BRICK {95,1,BRICK_WIDTH,BRICK_HEIGHT}
#define BLUE2_BRICK {127,1,BRICK_WIDTH,BRICK_HEIGHT}
#define GREEN2_BRICK {159,1,BRICK_WIDTH,BRICK_HEIGHT}
...
void draw()
{
	...
	if (
		(ball.y + 24 > win_surf->h - 32) &&
		(ball.x + 24 > x_vault) &&
		(ball.x < x_vault + 128) &&
		(ball.y < win_surf->h - 32))
	{
